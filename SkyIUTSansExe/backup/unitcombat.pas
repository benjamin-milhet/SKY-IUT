...
begin
  ...
  monstre.PDV:=20;//point de vie du monstre
  monstre.typeM:='monstreNuit';
  //monstre.PM:=80;
  attaqueMonstre1.nom:='dague';//nom premiere attaque
  attaqueMonstre1.degat:=5;//degat premiere attaque
  attaqueMonstre2.nom:='peur';//nom deuxieme attaque
  attaqueMonstre2.degat:=8;//degat deuxieme attaque
  nomR:='Croc de Ragnard|';
end;
